# Welcome to DRC Wiki :material-drone:
...
## 🛠️ Content Standards
To keep this hangar clean, follow the **Signal-over-Noise** principle:
...
* **SOPs:** Step-by-step guides that a new member could follow without supervision.

**❌ What NOT to Write:**
* **Redundant Manuals:** Don't copy-paste the Betaflight or ArduPilot wiki. Link to it.
* **Ephemeral Data:** Don't document daily weather or current battery voltages. Keep it evergreen.
* **Unverified Hacks:** If you bypassed a safety sensor, label it as a **temporary workaround**, not a standard procedure.

---

> **Note:** All flight logs must be uploaded within 24 hours of a field test. Boring flights are still data—document them.
